  ...
  const features = [
    {
      ...
      description: "Promouvoir la paix et la résolution des conflits par la médiation et la négociation internationale.",
    },
    {
      icon: <Target className="w-8 h-8" />,
      title: t('presentation.neutrality'),
      description: "Maintenir une position neutre et impartiale dans tous les processus de médiation.",
    },
    {
      icon: <MessageCircle className="w-8 h-8" />,
      title: t('presentation.commissions'),
      description: "Coordonner les différentes commissions spécialisées dans la résolution de conflits.",
    },
  ];
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Découvrez les valeurs et principes qui guident notre action
            </p>
          </div>
      ...
      <section className="py-20 bg-navy-900">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Ensemble, construisons un monde plus pacifique grâce à la médiation et à la négociation
          </p>
